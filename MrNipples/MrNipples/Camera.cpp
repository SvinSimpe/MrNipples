...
Camera::Camera()
{
	...
	mEyePosition		= XMFLOAT3( 25.0f, 50.0f, -200.0f);
	...
	mFocusPosition		= XMFLOAT3( 0.0f, 0.0f, 100.0f );
	...
	XMMATRIX tempProjectionMatrix = XMMatrixPerspectiveFovLH( 0.75f, 1280.0f / 720.0f, 0.5f, 5000.0f );
